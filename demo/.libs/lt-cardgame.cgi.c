...
/* ./.libs/lt-cardgame.cgi.c - temporary wrapper executable for .libs/cardgame.cgi
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh cardgame.cgi",
   but could eventually absorb all of the scripts functionality and
   exec .libs/cardgame.cgi directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "cardgame.cgi"; /* hopefully, no .exe */
